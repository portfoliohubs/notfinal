...
export const CONFIG = {
  ...
  tierLimits: {
    ...
    buildUpgradeMessage: (doctorName?: string) => {
      const cleanName = (doctorName || '').trim();
      const namePart = cleanName ? ` ${cleanName}` : '';
      return `مرحباً، أنا الدكتور${namePart}، وصلت للحد الأقصى للحالات على PortfolioHubs وأرغب في الترقية.`;
    },
  },
  whatsapp: {
  ...
  portfolioIntro: {
    ...
    liveExamples: [
      { photo: "https://github.com/user-attachments/assets/97ba84f2-8190-4ea6-b396-c6beb0bb3572", name: "Dr.Michael Nabil", link: "https://portfoliohubs.pages.dev/drmichaelnabil" },
      { photo: "https://github.com/user-attachments/assets/1c669ac9-2b53-4c18-b396-821409c6ada4", name: "Dr. Hanan Sakr", link: "https://portfoliohubs.pages.dev/drhanansakr" },
      { photo: "https://github.com/user-attachments/assets/1fd807ab-3d10-41ee-9d63-57f097d1eab6", name: "Dr. Roaa Adel", link: "https://portfoliohubs.pages.dev/drroaaadel" },
      { photo: "https://github.com/user-attachments/assets/57302af1-dbce-4a6c-8773-f74fc6d9669f", name: "Dr. Hossam Lotfy", link: "https://portfoliohubs.pages.dev/drhossamlotfy" },
      { photo: "https://github.com/user-attachments/assets/b9c66a94-55d2-4fbd-9500-e7acdc01a9d3", name: "Dr. Rawan Mahmoud", link: "https://portfoliohubs.pages.dev/drrawanmahmoud" },
      { photo: "https://github.com/user-attachments/assets/f8c883ac-4a8e-4e0e-ab04-04ec7c771eed", name: "Dr. Abanoub Nageh", link: "https://portfoliohubs.pages.dev/drabanoubnageh" },
      { photo: "https://github.com/user-attachments/assets/32d363af-0c59-4bae-9ba3-97330259af67", name: "Dr. Abrar Kamal", link: "https://portfoliohubs.pages.dev/drabrarkamal" },
      { photo: "https://github.com/user-attachments/assets/9061d11c-6854-4d58-b240-db0314d816eb", name: "Dr. Youstina Elkes Ghabrial", link: "https://portfoliohubs.pages.dev/dryoustinaelkesghabrial" },
      { photo: "https://github.com/user-attachments/assets/7e5e9e46-5a49-4c65-af7e-e7bb21601bdc", name: "Dr. Eslam Anas Abdelwahab", link: "https://portfoliohubs.pages.dev/dreslamanas" },
    ] as LiveExample[],
  },
  payWhatYouWant: {
    enabled: "off",
